...
force grenades_hatches_main_allowedGrenadesSetting = "['HandGrenade', 'MiniGrenade', 'GrenadeMolotovPSRUS']";
...
force ace_medical_gui_bodyPartOutlineColor = [0,1,0.8,1];
...
force Vcm_AISkills_General_AimingAccuracy = 0.35;
force Vcm_AISkills_General_aimingShake = 0.4;
force Vcm_AISkills_General_aimingSpeed = 0.45;
