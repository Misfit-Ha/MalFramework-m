...
diwako_dui_compass_opacity = 0.8;
...
diwako_dui_radar_namelist_vertical_spacing = 1.02857;
diwako_dui_radar_occlusion_fade_in_time = 1;
diwako_dui_radar_occlusion_fade_time = 2;
diwako_dui_radar_pointer_color = [0,1,1,1];
...
force tsp_cba_breach_ammo_multiplier = 10;
