...
[
    {
        params ["_newGroup", "_spawnPos", "_special", "_unlimitedAmmo", "_vehicleData", "_infantryData", "_waypoints"];
        ( !isNull _newGroup )
    },
    {
        params ["_newGroup", "_spawnPos", "_special", "_unlimitedAmmo", "_vehicleData", "_infantryData", "_waypoints"];
    ...
    }, [_newGroup, _spawnPos, _special, _unlimitedAmmo, _vehicleData, _infantryData, _waypoints]
